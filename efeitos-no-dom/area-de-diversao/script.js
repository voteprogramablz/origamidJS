...
const countNumbersLessThan501 = (acc, item) =>item < 501 ? ++acc : acc 

const crazyNumbers = [937, 5, 395, 402, 501, 333, 502, 781, 3, 691]
const numbersSmallerThan501 = crazyNumbers.reduce(countNumbersLessThan501, 0)
...
const cartGames = cart.reduce((acc, { name }) =>
  acc + '- ' + name + '\n', '')
